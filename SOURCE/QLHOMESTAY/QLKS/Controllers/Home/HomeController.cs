...
namespace QLKS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<QLKS.Models.tblTinNhan> dstn = db.tblTinNhans.OrderByDescending(t => t.ngay_gui).Take(5).ToList();
            ViewBag.Dstn = dstn;

            // Truy vấn dữ liệu từ CSDL
            List<tblTinNhan> tinNhans = db.tblTinNhans.ToList();
        ...
        public double CalculateAverageRating(List<tblTinNhan> tinNhans)
        {
        ...
        public ActionResult TimPhong(string id)
        {
            try
            {
                List<int> ds;
            ...
            var dstn = db.tblTinNhans.OrderByDescending(t => t.ngay_gui).Take(5).ToList();
        ...
        public ActionResult GioiThieuPhong()
